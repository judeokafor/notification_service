...
var routers_1 = __webpack_require__(74);
var pack = __importStar(__webpack_require__(85));
dotenv.config();
try {
    var apps = new node_service_base_1.default({
        ...
        middlewares: [
            ...
            middlewares_1.urlShortnerProviderMiddleware,
        ],
        name: pack.name,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.urlShortnerProviderMiddleware = exports.whatsappProviderMiddleware = exports.slackProviderMiddleware = exports.smsProviderMiddleware = exports.emailProviderMiddleware = void 0;
...
var smsProvider_1 = __webpack_require__(63);
...
var slackProvider_1 = __webpack_require__(68);
...
var whatsappProvider_1 = __webpack_require__(70);
...
var urlShortnerProvider_1 = __webpack_require__(73);
Object.defineProperty(exports, "urlShortnerProviderMiddleware", ({ enumerable: true, get: function () { return __importDefault(urlShortnerProvider_1).default; } }));
...
exports.SMS = __importStar(__webpack_require__(12));
exports.EMAIL = __importStar(__webpack_require__(31));
...
var consistentLoan_1 = __webpack_require__(13);
...
var earlyRepaymentReminder_1 = __webpack_require__(14);
...
var disbursalFailure_1 = __webpack_require__(15);
...
var repaymentInvoice_1 = __webpack_require__(30);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.abbreviateName = exports.formatCurrency = exports.toTitleCase = void 0;
var capitalize_1 = __importDefault(__webpack_require__(17));
var currency_formatter_1 = __importDefault(__webpack_require__(18));
...
var abbreviateName = function (businessOwnerName) {
    var abbreviatedName = '';
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var utils_1 = __webpack_require__(16);
var sendOffer_1 = __webpack_require__(23);
var clientAppUrl = process.env._CLIENT_APP_URL || '';
...
var moment_1 = __importDefault(__webpack_require__(24));
var base_1 = __importDefault(__webpack_require__(25));
var utils_1 = __webpack_require__(16);
var OpportunityType;
...
var welcome_email_1 = __importDefault(__webpack_require__(32));
exports.default = {
    welcomeEmail: welcome_email_1.default,
};
var agentInvitation_1 = __webpack_require__(33);
...
var associationRequirement_1 = __webpack_require__(34);
...
var confirmGuarantor_1 = __webpack_require__(35);
...
var consistentOverdueLoans_1 = __webpack_require__(36);
...
var earlyRepaymentReminder_1 = __webpack_require__(39);
Object.defineProperty(exports, "earlyRepaymentReminder", ({ enumerable: true, get: function () { return __importDefault(earlyRepaymentReminder_1).default; } }));
var disbursalFailure_1 = __webpack_require__(40);
Object.defineProperty(exports, "disbursalFailure", ({ enumerable: true, get: function () { return __importDefault(disbursalFailure_1).default; } }));
var guarantorAccepted_1 = __webpack_require__(41);
...
var guarantorNotAccepted_1 = __webpack_require__(42);
...
var guarantorRequest_1 = __webpack_require__(43);
...
var returningOpportunity_1 = __webpack_require__(58);
...
var signupConfirmation_1 = __webpack_require__(59);
...
var statementReminder_1 = __webpack_require__(60);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var termii_1 = __importDefault(__webpack_require__(64));
exports.default = (function (req, _, next) {
    var appSecrets = req.appSecrets;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var node_service_base_1 = __webpack_require__(1);
var axios_1 = __importDefault(__webpack_require__(65));
var common_enums_1 = __webpack_require__(8);
var phoneNumberMessage_base_1 = __importDefault(__webpack_require__(66));
...
var utils_1 = __webpack_require__(16);
var Message_base_1 = __importDefault(__webpack_require__(10));
var bitly_1 = __importDefault(__webpack_require__(67));
var PhoneNumberBasedMessage = /** @class */ (function (_super) {
    ...
    function PhoneNumberBasedMessage() {
        var _this = _super.call(this) || this;
        _this.urlShortnerProvider = new bitly_1.default({
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        if (data.businessOwnerName) {
                            data.businessOwnerName = utils_1.abbreviateName(data.businessOwnerName);
                        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var slack_1 = __importDefault(__webpack_require__(69));
exports.default = (function (req, _, next) {
    var appSecrets = req.appSecrets;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var twillo_1 = __importDefault(__webpack_require__(71));
exports.default = (function (req, _, next) {
    var appSecrets = req.appSecrets;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var twilio_1 = __importDefault(__webpack_require__(72));
var node_service_base_1 = __webpack_require__(1);
var common_enums_1 = __webpack_require__(8);
var phoneNumberMessage_base_1 = __importDefault(__webpack_require__(66));
...
exports.default = (function (req, _, next) {
    var appSecrets = req.appSecrets;
    if (appSecrets === null || appSecrets === void 0 ? void 0 : appSecrets.bitly) {
        var token = appSecrets.bitly.token;
        req.appServices.urlShortnerProvider = new bitly_1.default({
            token: token,
        });
    }
    next();
...
var message_1 = __webpack_require__(79);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var express_1 = __importDefault(__webpack_require__(76));
var controllers_1 = __webpack_require__(77);
...
var example_1 = __webpack_require__(78);
...
var express_1 = __importDefault(__webpack_require__(76));
var container_awilix_1 = __importDefault(__webpack_require__(80));
var router = express_1.default.Router();
...
var node_service_base_1 = __webpack_require__(1);
var awilix_1 = __webpack_require__(84);
...
var service_1 = __importDefault(__webpack_require__(82));
exports.NotificationService = service_1.default;
var controller_1 = __importDefault(__webpack_require__(83));
